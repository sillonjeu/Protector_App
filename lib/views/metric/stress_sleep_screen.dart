...
class StressSleepScreen extends BaseScreen<StressSleepViewModel> {
  const StressSleepScreen({super.key});

  @override
  Widget buildBody(BuildContext context) {
    final StressSleepViewModel viewModel = Get.find<StressSleepViewModel>();
